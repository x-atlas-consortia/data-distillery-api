...
As a Flask application, the data-distillery-api can be deployed in various environments.
...
An instance of data-distillery-api can override the default timeout in its app.cfg file.
